...
public class ESC {
   ...
   public static String NINTYDEGREEROTATION			="<0x1B><0x56><0x01>";
    public static String LANDSCAPE			="<0x14>";
    public static String ESCD			="<0x1B><0x44><01FF>";
    ...
    public static String printBoldCenterLarge(String message)
    {
        String data="! 0 200 200 100 1\r\n" +
                "CENTER\r\n" +
                "TEXT 5 3 0 0 "+message+"\r\n" +
                "PRINT\r\n";
        return data;
    }
    public static String printBoldCenterSmall(String message)
    {
        String data="! 0 200 200 25 1\r\n" +
                "CENTER\r\n" +
                "TEXT 5 0 0 0 "+message+"\r\n" +
                "PRINT\r\n";
        return data;
    }
    public static String printBoldCenterMedium(String message)
    {

        String data="! 0 200 200 50 1\r\n" +
                "CENTER\r\n" +
                "TEXT 5 2 0 0 "+message+"\r\n" +
                "PRINT\r\n";
        return data;
    }
