    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmit.setOnClickListener(View.OnClickListener {
            ...
            !isValidEmail(etEmail.text.toString()) -> {
                Toast.makeText(this,"Plaese enter a valid email address",Toast.LENGTH_LONG).show()
                ...
                !cbTerms.isChecked ->{
                    Toast.makeText(this,"Please select our terms and condition",Toast.LENGTH_LONG).show()
                }
